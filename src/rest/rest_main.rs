use crate::{rest::pages::{team_join, version_check, player_message, listen_for_chats, minecraft_event}, minecraft::MinecraftMsg};
...
pub async fn start_rocket() -> Result<(), rocket::Error> {
    ...
    let rocket = rocket::build()
        ...
        .mount("/", routes![team_join, version_check, player_message, listen_for_chats, minecraft_event]);
